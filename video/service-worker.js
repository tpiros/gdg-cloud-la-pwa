(function (factory) {
  ...
  */
  ...
  function calculateEffectiveBoundaries(blob, start, end) {
    ...
    if (end && end > blobSize || start && start < 0) {
      throw new WorkboxError$2('range-not-satisfiable', {
        size: blobSize,
        end: end,
        start: start
      });
  ...
  */
  ...
  function parseRangeHeader(rangeHeader) {
    ...
    if (!normalizedRangeHeader.startsWith('bytes=')) {
      throw new WorkboxError$2('unit-must-be-bytes', {
    ...
    if (normalizedRangeHeader.includes(',')) {
      throw new WorkboxError$2('single-range-only', {
        normalizedRangeHeader: normalizedRangeHeader
      });
    }
    ...
    if (!rangeParts || !(rangeParts[1] || rangeParts[2])) {
      throw new WorkboxError$2('invalid-range-values', {
        normalizedRangeHeader: normalizedRangeHeader
      });
    }
  ...
  function createPartialResponse(_x, _x2) {
    return _createPartialResponse.apply(this, arguments);
  }

  function _createPartialResponse() {
    _createPartialResponse = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(request, originalResponse) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", originalResponse);
            ...
            case 4:
              ...
              throw new WorkboxError$2('no-range-header');
  ...
  var RangeRequestsPlugin = function RangeRequestsPlugin() {
    _classCallCheck(this, RangeRequestsPlugin);
    ...
    this.cachedResponseWillBeUsed = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
        var request, cachedResponse;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                request = _ref.request, cachedResponse = _ref.cachedResponse;
  ...
  */
  ...
  var fallback$3 = function fallback(code) {
    var msg = code;
  ...
  var messageGenerator$3 =  fallback$3 ;
  ...
  var WorkboxError$3 = /*#__PURE__*/function (_Error) {
    _inherits(WorkboxError, _Error);
    ...
    function WorkboxError(errorCode, details) {
      ...
      var message = messageGenerator$3(errorCode, details);
      _this = _super.call(this, message);
      _this.name = errorCode;
      _this.details = details;
      return _this;
  ...
  */
  ...
  function createCacheKey(entry) {
    if (!entry) {
      throw new WorkboxError$3('add-to-cache-list-unexpected-type', {
        entry: entry
      });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              throw new WorkboxError$3('cross-origin-copy-response', {
                origin: origin
              });
          ...
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 7:
                  throw new WorkboxError$3('missing-precache-entry', {
                ...
                case 14:
                  ...
                  logger$1.groupCollapsed("Precaching is responding to: " + getFriendlyURL$2(request.url));
                  logger$1.log("Serving the precached url: ".concat(getFriendlyURL$2(cacheKey.url)));
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                ...
                case 2:
                  ...
                  throw new WorkboxError$3('bad-precaching-response', {
                    url: request.url,
  ...
  var PrecacheController = /*#__PURE__*/function () {
    ...
    _createClass(PrecacheController, [{
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (this._urlsToCacheKeys.has(url) && this._urlsToCacheKeys.get(url) !== cacheKey) {
              throw new WorkboxError$3('add-to-cache-list-conflicting-entries', {
            ...
            if (typeof entry !== 'string' && entry.integrity) {
              if (this._cacheKeysToIntegrities.has(cacheKey) && this._cacheKeysToIntegrities.get(cacheKey) !== entry.integrity) {
                throw new WorkboxError$3('add-to-cache-list-conflicting-integrities', {
                  url: url
                });
              }
      ...
      value: function createHandlerBoundToURL(url) {
        ...
        if (!cacheKey) {
          throw new WorkboxError$3('non-precached-url', {
            url: url
          });
        }
  ...
  */
  ...
  precacheAndRoute([{"revision":"923748a8efad3189a846f877b4f90a60","url":"app.css"},{"revision":"c2341e341245e44c99031222226db992","url":"app.js"},{"revision":"e7e9600520a29c9ae238218956a99308","url":"index.html"}]);
